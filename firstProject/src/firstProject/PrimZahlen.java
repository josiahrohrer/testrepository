...
public class PrimZahlen {
	...
	public static void main(String[] args) {
		// ich möchte einen aloritmus entwerfen der eine mir Sagen kann ob eine Zahl prim ist oder nicht
	int eingeleseneZahl = einlesen();
	//System.out.println(eingeleseneZahl);
	boolean isPrime = true;
	for (int teiler = 2; teiler < eingeleseneZahl && isPrime == true && eingeleseneZahl > 0; teiler++){
