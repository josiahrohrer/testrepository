...
public class BinaerRechner {
	...
	public static void main(String[] args) {
		...
		if (Zahlensystem == 1) {// dezimalsystem zu binär
			...
			/*
			 * while (eingabeD > 0){ //System.out.println(eingabeD); int a =
			 * eingabeD % 2; eingabeD = eingabeD / 2; System.out.println(a); }
			 */
	...
	static int PopUp() {
		...
		int a = JOptionPane.showOptionDialog(null,
				"in was für einem System möchten sie die Zahl eigeben?",
				"Zahlensystem", JOptionPane.YES_NO_OPTION,
				JOptionPane.INFORMATION_MESSAGE, null, myOptions, null);
		return a;
	}
}
